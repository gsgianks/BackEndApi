...
{
    public class HojaRecibimientoRepository : Repository<HojaRecibimiento>, IHojaRecibimientoRepository
    {
        public HojaRecibimientoRepository(string connectionString) : base(connectionString)
        {
        }
